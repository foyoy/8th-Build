    ...
    def show_dialog(self, *args):
        if not self.dialog_test:
            self.dialog_test = MDDialog(
                ...
                #width_offset = dp(70),
                size_hint= (.8, None),
                text = "[b]Remove all glasses with colored lenses:[/b] Taking this test with only your naked eye will provide you with the most accurate results. Wearing a colored lens can make your results inaccurate.\n\n[b]Turn up your screen brightness:[/b] Brighter colors are easier to perceive.\n\n[b]Test Format:[/b] You will see a series of button image, these are protanopia, deuteranopia, tritanopia, and monochromacy. You will also see a reference button, which located at the bottom right corner. Tap the image to match the reference image corresponding on which image you see.",
                auto_dismiss=False,
                buttons = [
                    MDIconButton(
